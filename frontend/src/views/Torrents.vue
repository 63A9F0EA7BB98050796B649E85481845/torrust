...
export default {
  ...
  methods: {
    loadTorrents(page) {
      HttpService.get(`/torrents?page_size=${this.pageSize}&page=${page-1}&sort=${this.sorting.name}_${this.sorting.direction}&categories=${this.filters.join(',')}&search=${this.search.replace(/\W/g, "")}`, (res) => {
